...
VALUES ('TNT-000001', -- internal_id
        ...
        (select id from m_country where country_code2 ='IN'), -- country_id  → update once countries seed is in
        NULL, -- default_locale_id → update once locales seed is in
        (select id from m_currency where currency_code='INR'), -- default_currency_id → update once currencies seed is in
