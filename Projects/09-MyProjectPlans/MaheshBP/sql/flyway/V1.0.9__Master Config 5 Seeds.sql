...
-- Sample data for m_communication_channel
INSERT INTO m_auth_provider (internal_id, provider_key, name, status, created_at, updated_at, version)
...
INSERT INTO m_role (internal_id, role_key, name, user_type)
...
INSERT INTO security.m_permission (internal_id, permission_key, name, domain, created_at, updated_at, version)
VALUES
...
INSERT INTO security.map_role_permission (internal_id, role_id, permission_id, created_at, updated_at, version)
...
FROM (VALUES
         ...
         JOIN m_role r ON r.role_key = mapping.role_key
         JOIN m_permission p ON p.permission_key = mapping.permission_key;
