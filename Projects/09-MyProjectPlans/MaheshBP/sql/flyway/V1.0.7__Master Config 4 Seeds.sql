...
INSERT INTO m_service_tier
(id, internal_id, tier_key, name, description, min_spend, min_bookings, discount_percent, priority_booking,
 display_order,
 status, created_at, updated_at, version)
VALUES (1, 'SVC-TIER-001', 'NORMAL', 'Normal', 'Default tier for all new customers', 0, 0, 0.00, FALSE, 1, 'A', NOW(),
        NOW(), 1),
       (2, 'SVC-TIER-002', 'SILVER', 'Silver', 'Customers with moderate booking history', 500, 5, 5.00, FALSE, 2, 'A',
        NOW(), NOW(), 1),
       (3, 'SVC-TIER-003', 'GOLD', 'Gold', 'Loyal customers with high booking history', 1500, 15, 10.00, FALSE, 3, 'A',
        NOW(), NOW(), 1),
       (4, 'SVC-TIER-004', 'VIP', 'VIP', 'High value customers with premium spend', 3000, 30, 15.00, TRUE, 4, 'A',
        NOW(),
        NOW(), 1),
       (5, 'SVC-TIER-005', 'PREMIUM', 'Premium', 'Top tier customers with exclusive benefits', 5000, 50, 20.00, TRUE, 5,
        'A', NOW(), NOW(), 1);

INSERT INTO m_service_type (id, internal_id, name, display_order, status, created_at, updated_at, version)
VALUES (1, 'SVC-TYPE-001', 'Hair', 1, 'A', NOW(), NOW(), 1),
       (2, 'SVC-TYPE-002', 'Skin', 2, 'A', NOW(), NOW(), 1),
       (3, 'SVC-TYPE-003', 'Nails', 3, 'A', NOW(), NOW(), 1),
       (4, 'SVC-TYPE-004', 'Makeup', 4, 'A', NOW(), NOW(), 1),
       (5, 'SVC-TYPE-005', 'Massage', 5, 'A', NOW(), NOW(), 1),
       (6, 'SVC-TYPE-006', 'Spa', 6, 'A', NOW(), NOW(), 1),
       (7, 'SVC-TYPE-007', 'Beard', 7, 'A', NOW(), NOW(), 1),
       (8, 'SVC-TYPE-008', 'Eyebrow', 8, 'A', NOW(), NOW(), 1),
       (9, 'SVC-TYPE-009', 'Eyelash', 9, 'A', NOW(), NOW(), 1),
       (10, 'SVC-TYPE-010', 'Waxing', 10, 'A', NOW(), NOW(), 1),
       (11, 'SVC-TYPE-011', 'Threading', 11, 'A', NOW(), NOW(), 1),
       (12, 'SVC-TYPE-012', 'Hair Removal', 12, 'A', NOW(), NOW(), 1),
       (13, 'SVC-TYPE-013', 'Tattoo', 13, 'A', NOW(), NOW(), 1),
       (14, 'SVC-TYPE-014', 'Piercing', 14, 'A', NOW(), NOW(), 1),
       (15, 'SVC-TYPE-015', 'Men Grooming', 15, 'A', NOW(), NOW(), 1);

INSERT INTO m_service_category (internal_id, service_type_id, name, description, display_order, status, created_at,
                                updated_at, version)
VALUES
...
INSERT INTO m_pricing_scope (internal_id, name, status, created_at, updated_at, version)
VALUES ('PRC-SCP-001', 'TENANT', 'A', NOW(), NOW(), 1),
       ('PRC-SCP-002', 'BUSINESS', 'A', NOW(), NOW(), 1),
       ('PRC-SCP-003', 'BRANCH', 'A', NOW(), NOW(), 1);

INSERT INTO m_duration_unit (internal_id, name, to_minutes, status, created_at, updated_at, version)
VALUES ('DUR-UNIT-001', 'Minutes', 1, 'A', NOW(), NOW(), 1),
       ('DUR-UNIT-002', 'Hours', 60, 'A', NOW(), NOW(), 1),
       ('DUR-UNIT-003', 'Days', 1440, 'A', NOW(), NOW(), 1);


INSERT INTO m_addon_type (internal_id, type_key, name, status, version)
...
INSERT INTO m_staff_tier (internal_id, name, display_order, status, created_at, updated_at, version)
...
INSERT INTO m_service_tag (internal_id, tag_key, name, status, version)
VALUES
    -- Trending / Popularity
...
INSERT INTO map_service_tier_customer_tier (internal_id, service_tier_id, customer_tier_id, status, version)
...
INSERT INTO m_item_type (internal_id, name, status, version)
VALUES ('ITEM-TYPE-001', 'Service', 'A', 1),
       ('ITEM-TYPE-002', 'Produce', 'A', 1);
